...
class ExplorerWorkspace(wx.Panel):
    ...
    def _build_main_menu_bar(self):
        ...
        self.file_print_item = menu_utils.append_menu_command(self.file_menu, self, menu_utils.FILE_COMMANDS["print"], context_factory=list_context)
        self.file_menu.AppendSeparator()
        self.file_copy_item = menu_utils.append_menu_command(self.file_menu, self, menu_utils.FILE_COMMANDS["copy"], context_factory=list_context)
        self.file_cut_item = menu_utils.append_menu_command(self.file_menu, self, menu_utils.FILE_COMMANDS["cut"], context_factory=list_context)
        self.file_paste_item = menu_utils.append_menu_command(self.file_menu, self, menu_utils.FILE_COMMANDS["paste"], context_factory=list_context)
        ...
        self.file_rename_files_item = menu_utils.append_menu_command(self.file_menu, self, menu_utils.FILE_COMMANDS["rename_files"], context_factory=list_context)
        self.file_delete_item = menu_utils.append_menu_command(self.file_menu, self, menu_utils.FILE_COMMANDS["delete"], context_factory=list_context)
        self.file_delete_permanent_item = menu_utils.append_menu_command(self.file_menu, self, menu_utils.FILE_COMMANDS["delete_permanent"], context_factory=list_context)
        self.file_menu.AppendSeparator()
        self.file_archive_item = menu_utils.append_menu_command(self.file_menu, self, menu_utils.FILE_COMMANDS["archive"], context_factory=list_context)
        self.file_extract_archive_item = menu_utils.append_menu_command(self.file_menu, self, menu_utils.FILE_COMMANDS["extract_here"], context_factory=list_context)
        self.file_extract_archive_into_item = menu_utils.append_menu_command(self.file_menu, self, menu_utils.FILE_COMMANDS["extract_into"], context_factory=list_context)
        self.file_menu.AppendSeparator()
        ...
        self.doc_merge_item = menu_utils.append_menu_command(self.document_menu, self, menu_utils.FILE_COMMANDS["merge"], context_factory=list_context)
    ...
    def _update_main_menu_state(self):
        ...
        self.doc_merge_item.Enable(bool(menu_utils.merge_selected_path(filelist.build_list_command_context(self, source="main"))))
    ...
    def refresh_locale(self):
        ...
        if hasattr(self, "menu_bar") and self.menu_bar is not None:
            ...
            self.file_rename_files_item.SetItemLabel(tr("rename_files"))
            ...
            self.doc_merge_item.SetItemLabel(tr("merge_documents"))
        ...
        self.list_merge_btn.SetToolTip(tr("merge_documents"))
