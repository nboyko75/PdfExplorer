TRANSLATIONS = {
    ...
    "preview_show_1_page_tall": "1 page tall",
    ...
    "preview_adjust_page_width_button": "Adjust page width",
...
TRANSLATIONS.update({'license_title': 'DocExplorer — Microsoft Store', 'license_checking': 'Checking your Microsoft Store license…', 'license_retry': 'Check again', 'license_buy': 'Open Microsoft Store', 'license_exit': 'Exit', 'license_error': 'The Microsoft Store license could not be verified. Connect to the Internet, sign in to Microsoft Store with the purchasing account, and try again.', 'license_expired': 'The trial has expired or no active license was found. Purchase DocExplorer in Microsoft Store, then click Check again. Exit lets you save any pending document changes.', 'license_trial': 'Trial: {days} day(s) remaining.\nExpires: {date}\n\nYou can purchase the full version in Microsoft Store.', 'license_store_failed': 'Microsoft Store could not be opened.'})

TRANSLATIONS.update({'explorer_new_tab': 'New tab', 'explorer_close_tab': 'Close tab', 'explorer_folder_unavailable': 'Folder is unavailable:\n{path}'})


TRANSLATIONS.update({'merge_documents': 'Merge similar documents', 'merge_search': 'Search', 'merge_compare': 'Compare', 'merge_save': 'Save', 'merge_target': 'Target workbook', 'merge_empty': 'Empty', 'merge_keep': 'Keep original / reject', 'merge_choose': 'Choose a value…', 'merge_ready': 'Search this folder for similar Excel workbooks.', 'merge_working': 'Processing…', 'merge_failed': 'Operation failed.', 'merge_recompare': 'Selection changed. Compare again.', 'merge_cancelling': 'Waiting for the current operation to finish…', 'merge_unresolved': 'Resolve or reject every conflict before saving.', 'merge_readonly': 'The workbook is read-only.', 'merge_unmatched': 'Sheets without an exact name match were not merged:', 'merge_instructions': 'Local content search; compare matching sheet names and cell addresses. Select a cell to choose a value; keep the original to reject a change. Microsoft Excel is required.', 'merge_found': 'Found: {count}. Could not read: {skipped}.', 'merge_conflicts': 'Conflicting cells: {total}. Unresolved: {count}.', 'merge_changed': 'File changed. Search again: {path}', 'merge_too_large': 'Workbook exceeds the {count}-cell review limit: {path}', 'merge_protected': 'Protected, merged or array-formula cell cannot be changed on sheet: {sheet}', 'merge_external_formula': 'External workbook formulas cannot be imported on sheet: {sheet}'})

TRANSLATIONS["merge_preview"] = 'Preview'

TRANSLATIONS.update({'rename_files': 'Rename files', 'rename_find_regex': 'Find (regular expression)', 'rename_replace_regex': 'Replace with (replacement expression)', 'rename_found_names': 'Found file names', 'rename_new_names': 'New file names', 'rename_invalid_name': 'Invalid file name.', 'rename_conflict': 'The destination name already exists or is duplicated.', 'rename_changed': 'A file has changed since Search. Search again.', 'rename_empty_pattern': 'Enter a search expression.', 'rename_regex_error': 'Invalid regular expression or replacement.', 'rename_io_error': 'The operation could not be completed. Some files may already have been renamed. Search again.', 'rename_matches': 'Found: {count}', 'rename_saved': 'Renamed: {count}'})

TRANSLATIONS.update({'rename_blocked_title': 'Cannot rename file', 'rename_blocked_message': 'Cannot rename:\n{source}\n\nTo:\n{target}\n\nResolve the problem and retry, skip this file or all files with errors, or cancel the remaining operation. Files already renamed will keep their new names.', 'rename_blocked_retry': 'Retry', 'rename_blocked_skip': 'Skip', 'rename_blocked_skip_all': 'Skip all', 'rename_blocked_cancel': 'Cancel'})

TRANSLATIONS.update({'export_unsupported_format': 'Unsupported export file format.'})
