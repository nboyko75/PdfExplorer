...
DEFAULT_TRANSLATIONS: Dict[str, str] = {
    ...
    "favorite_shortcuts_button": "Standard shortcuts",
    "standard_shortcuts_toggle_show_tooltip": "Show standard shortcuts",
    "standard_shortcuts_toggle_hide_tooltip": "Hide standard shortcuts",
