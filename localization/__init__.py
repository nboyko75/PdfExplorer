...
DEFAULT_TRANSLATIONS: Dict[str, str] = {
    ...
    "pdf_keep_one_page": 'A PDF must contain at least one page.',
    ...
    "favorite_column_header": "Favorite",
    "favorite_shortcuts_button": "Wellknown shortcuts",
    "standard_shortcuts_toggle_show_tooltip": "Show wellknown shortcuts",
    "standard_shortcuts_toggle_hide_tooltip": "Hide wellknown shortcuts",
    "favorite_shortcut_desktop": "Desktop",
    "favorite_shortcut_documents": "Documents",
    "favorite_shortcut_downloads": "Downloads",
    "favorite_shortcut_images": "Images",
    "favorite_shortcut_music": "Music",
    "favorite_shortcut_video": "Videos",
    "favorite_shortcut_recycle_bin": "Recycle Bin",
    "favorite_move_up_button": "Move favorite panel up",
    ...
    "search_query_label": "Search expression",
    "search_file_mask_label": "File mask",
    "search_clear_mask_tooltip": "Clear mask",
    "search_filename_checkbox": "Search for file name",
    "search_file_content_checkbox": "Search in file content",
    ...
    "context_open": "Open",
    "context_open_with": "Open with",
    "open_with_choose_app": "Choose another app…",
    "open_with_unavailable": "The file or selected application is no longer available.",
    ...
    "archive_extract_override": "Overwrite",
    "archive_extract_rename": "Rename",
    "archive_extract_conflict_message": "The following files already exist in {path}:\n{names}\n\nChoose how to continue.",
...
DEFAULT_TRANSLATIONS.update({'rename_files': 'Rename files', 'rename_find_regex': 'Find (regular expression)', 'rename_replace_regex': 'Replace with (replacement expression)', 'rename_found_names': 'Found file names', 'rename_new_names': 'New file names', 'rename_invalid_name': 'Invalid file name.', 'rename_conflict': 'The destination name already exists or is duplicated.', 'rename_changed': 'A file has changed since Search. Search again.', 'rename_empty_pattern': 'Enter a search expression.', 'rename_regex_error': 'Invalid regular expression or replacement.', 'rename_io_error': 'The operation could not be completed. Some files may already have been renamed. Search again.', 'rename_matches': 'Found: {count}', 'rename_saved': 'Renamed: {count}'})
